...
public class LineMapChartAudioSimulatedUsingSameDynamicData extends JFrame{
	...
	public static void main(String[] args) {
		...
		final LineMapChartAudioSimulatedUsingSameDynamicData app = new LineMapChartAudioSimulatedUsingSameDynamicData();
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				...
				try {
					...
					entry.insertTo(chartView, chartView2);
